...
- 회원가입, 로그인, 비밀번호 재설정, 이메일 인증 등은 Supabase Auth JS SDK로 처리
- 패스코드/OTP UI는 직접 구현 (웹 접근 보안용)

### 2. 인증 페이지

- [ ] 회원가입 페이지 (`app/routes/_auth.auth.signup.tsx`) - Supabase Auth로 회원가입
- [ ] 로그인 페이지 (`app/routes/_auth.auth.signin.tsx`) - Supabase Auth로 로그인
- [ ] **(신규)** 보안 쉴드 페이지 (`app/routes/_auth.auth.shield.tsx`) - (직접 구현) 패스코드 입력
- [ ] **(신규)** 2단계 인증(OTP) 페이지 (`app/routes/_auth.auth.otp.tsx`) - (직접 구현) OTP 코드 입력
- [ ] 비밀번호 재설정 요청 페이지 (`app/routes/_auth.auth.forgot-password.tsx`) - Supabase Auth로 비밀번호 재설정 요청
- [ ] 비밀번호 재설정 페이지 (`app/routes/_auth.auth.reset-password.tsx`) - Supabase Auth로 비밀번호 재설정
- [ ] 이메일 인증 페이지 (`app/routes/_auth.auth.verify-email.tsx`) - Supabase Auth로 이메일 인증
- [ ] 인증 폼 컴포넌트 (내부 컴포넌트)
...
- [ ] 블로그 휴지통 페이지 (`app/routes/admin.blogs.trash.tsx`)
- [ ] 블로그 휴지통 목록 컴포넌트 (내부 컴포넌트)
- [ ] 블로그 복원 버튼 (내부 컴포넌트)
- [ ] 블로그 영구삭제 버튼 (내부 컴포넌트)
...
- [ ] 포스트 휴지통 페이지 (`app/routes/admin.posts.trash.tsx`)
- [ ] 포스트 휴지통 목록 컴포넌트 (내부 컴포넌트)
- [ ] 포스트 복원 버튼 (내부 컴포넌트)
- [ ] 포스트 영구삭제 버튼 (내부 컴포넌트)
...
- [ ] 댓글 휴지통 페이지 (`app/routes/admin.comments.trash.tsx`)
- [ ] 댓글 휴지통 목록 컴포넌트 (내부 컴포넌트)
- [ ] 댓글 복원 버튼 (내부 컴포넌트)
- [ ] 댓글 영구삭제 버튼 (내부 컴포넌트)
...
- [ ] 포스트 미리보기 모달 (내부 컴포넌트)
- [ ] 자동 저장 상태 표시 (내부 컴포넌트)
- [ ] 블로그 포스트 휴지통 페이지 (`app/routes/blogs.$slug.admin.posts.trash.tsx`)
- [ ] 블로그 포스트 휴지통 목록 컴포넌트 (내부 컴포넌트)
- [ ] 블로그 포스트 복원 버튼 (내부 컴포넌트)
- [ ] 블로그 포스트 영구삭제 버튼 (내부 컴포넌트)
...
- [ ] 블로그 댓글 휴지통 페이지 (`app/routes/blogs.$slug.admin.comments.trash.tsx`)
- [ ] 블로그 댓글 휴지통 목록 컴포넌트 (내부 컴포넌트)
- [ ] 블로그 댓글 복원 버튼 (내부 컴포넌트)
- [ ] 블로그 댓글 영구삭제 버튼 (내부 컴포넌트)
